...
import { getOnlySecond, deepCopy, getExtension } from './utility';
  ...
  */
  ...
  getTextEditors() {
    return (editor) => {
      ...
      editorState.fileTypes = deepCopy(editor.getGrammar().fileTypes);
      editorState.fileTypes.push(getExtension(editor.getPath())); //add file extension.
